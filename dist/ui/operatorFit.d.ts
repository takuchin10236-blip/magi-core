...
export declare const FIT_BASE_PX = 14;
/** 字の大きさの下限。これ以下は読めない（2026-09-05 実測で下限10px→7pxへ）。 */
export declare const FIT_MIN_PX = 7;
/** 字間を詰める時の刻み。推定値の丸め誤差を詰め切るためだけに使う。 */
export declare const FIT_TRACK_STEP_PX = 0.1;
/** 刻みの上限回数。推定から始めるので、実際は数回で収まる（無限ループを作らないための蓋）。 */
export declare const FIT_TRACK_MAX_STEPS = 24;
/**
 ...
 */
export declare function fitOperatorLabel(target: OperatorFitTarget): OperatorFitResult;
/** HTML 要素を測って直す実体。`Operator.tsx` から使う。 */
export declare function domFitTarget(span: HTMLElement): OperatorFitTarget;
//# sourceMappingURL=operatorFit.d.ts.map