...
export declare function compactPersonName(name: string): string;
...
export declare function NameWithRoom({ name, room, roomPrefix, className, suffix }: NameWithRoomProps): import("react").JSX.Element;
//# sourceMappingURL=NameWithRoom.d.ts.map