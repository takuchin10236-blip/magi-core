...
export declare function lockBodyScroll(doc?: Document): () => void;
/** 試験用: 今いくつのモーダルが背景スクロールを止めているか。 */
export declare function getBodyScrollLockDepth(): number;
/** 試験用: 状態を初期化する（試験間の持ち越しを防ぐ）。本番コードから呼ばない。 */
export declare function resetBodyScrollLockForTest(): void;
