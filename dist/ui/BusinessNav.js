...
export function BusinessNav({ tabs, activeTab, onNavigate, role, roleTitle, menuItems, menuChildren, menuFooter, navActions, navLeadingActions, focusMode, onFocusModeChange, menuLabel = 'メニュー', className, }) {
