...
export function ManualViewer({ content, onClose }) {
    ...
    return (_jsxs("div", { ref: dialogRef, className: "manual-fullpage", role: "dialog", "aria-modal": "true", "aria-label": `${content.appName} 操作マニュアル`, children: [_jsxs("header", { className: "manual-page-header manual-reader-actions", children: [_jsxs("button", { type: "button", className: "manual-action-btn manual-action-primary", onClick: onClose, "aria-label": "\u30DE\u30CB\u30E5\u30A2\u30EB\u3092\u9589\u3058\u3066\u30A2\u30D7\u30EA\u3078\u623B\u308B", title: "\u30A2\u30D7\u30EA\u3078\u623B\u308A\u307E\u3059\uFF08Esc \u3067\u3082\u623B\u308C\u307E\u3059\uFF09", children: [_jsx("span", { "aria-hidden": "true", children: "\u2190" }), " \u623B\u308B"] }), _jsx("button", { type: "button", className: "manual-action-btn", "aria-expanded": tocOpen, "aria-controls": "manual-toc-panel", onClick: () => setTocOpen((value) => !value), children: tocOpen ? '目次を隠す' : '目次を表示' }), _jsxs("button", { type: "button", className: "manual-action-btn", onClick: () => window.print(), "aria-label": "\u672C\u6587\u3092\u5370\u5237", children: [_jsx("span", { "aria-hidden": "true", children: "\uD83D\uDDA8" }), " \u672C\u6587\u3092\u5370\u5237"] }), _jsx("span", { className: "manual-page-eyebrow manual-actions-eyebrow", "aria-hidden": "true", children: "\uD83D\uDCD6 \u64CD\u4F5C\u30DE\u30CB\u30E5\u30A2\u30EB" })] }), _jsxs("div", { className: "manual-page-search", children: [_jsxs("div", { className: "manual-search-row", children: [_jsx("span", { className: "manual-search-icon", "aria-hidden": "true", children: "\uD83D\uDD0D" }), _jsx("input", { id: "manual-search-input", ref: searchInputRef, className: "manual-search-input", type: "search", value: query, onChange: (e) => setQuery(e.target.value), placeholder: "\u77E5\u308A\u305F\u3044\u3053\u3068\u3092\u63A2\u3059\uFF08\u4F8B: \u767A\u6CE8 / \u5370\u5237 / \u5728\u5EAB\uFF09", "aria-label": "\u30DE\u30CB\u30E5\u30A2\u30EB\u5185\u3092\u691C\u7D22", "aria-describedby": "manual-search-summary" }), query && (_jsx("button", { type: "button", className: "manual-search-clear", onClick: () => {
                                    setQuery('');
                                    searchInputRef.current?.focus();
                            ...
                            : `全 ${content.sections.length} 項目` })] }), _jsxs("div", { className: `manual-page-body${tocOpen ? '' : ' manual-toc-hidden'}`, children: [_jsxs("nav", { className: "manual-toc", "aria-label": "\u76EE\u6B21", id: "manual-toc-panel", hidden: !tocOpen, children: [_jsx("p", { className: "manual-toc-heading", children: "\u3053\u306E\u6587\u66F8\u306E\u76EE\u6B21" }), _jsx("ul", { className: "manual-toc-list", children: content.sections.map((s) => (_jsx("li", { className: s.collapsed ? 'is-unnumbered' : undefined, children: _jsx("button", { type: "button", className: `manual-toc-item${activeId === s.id ? ' active' : ''}`, onClick: () => jumpTo(s.id), title: s.summary || s.title, "aria-current": activeId === s.id ? 'true' : undefined, children: s.title }) }, s.id))) })] }), _jsx("div", { className: "manual-body", ref: bodyRef, children: _jsxs("div", { className: "manual-body-inner", children: [_jsxs("div", { className: "manual-doc-head", children: [_jsxs("p", { className: "manual-doc-badges", children: [_jsx("span", { className: "manual-doc-badge", children: "\u64CD\u4F5C\u30DE\u30CB\u30E5\u30A2\u30EB" }), content.appVersion && _jsxs("span", { className: "manual-doc-meta", children: ["\u7248 ", content.appVersion] })] }), _jsxs("h2", { className: "manual-doc-title", children: [content.appName, " \u64CD\u4F5C\u30DE\u30CB\u30E5\u30A2\u30EB"] }), content.subtitle && _jsx("p", { className: "manual-doc-lead", children: content.subtitle }), _jsx("hr", { className: "manual-doc-rule" })] }), hasResults ? (content.sections.map((s) => {
