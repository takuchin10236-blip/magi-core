...
export function DraggableModal({ onClose, title, subtitle, customHeader, maxWidth = 'xl', extraClass = '', children, footer, zIndex = 50, titleColorClass = 'text-[var(--color-primary)]', }) {
