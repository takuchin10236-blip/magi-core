 ...
 */
export type WriteReason = 'USER_NOT_ALLOWED' | 'ADMIN_REQUIRED' | 'ALLOW_WRITES_FALSE' | 'PRODUCTION_WRITE_NOT_APPROVED' | 'PREVIEW_WRITE_NOT_ALLOWED' | 'SPREADSHEET_ID_MISSING' | 'GOOGLE_SERVICE_ACCOUNT_MISSING';
